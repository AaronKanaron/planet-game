...
pub fn render_mesh(
    ...
    for &material_type in &[VoxelType::Rock, VoxelType::Dirt] {
        ...
        if !vertices.is_empty() && !indices.is_empty() {
            ...
            filled_mesh.insert_indices(bevy::render::mesh::Indices::U32(indices.clone()));
            ...
            if !wireframe_indices.is_empty() {
                ...
                wireframe_mesh.insert_indices(bevy::render::mesh::Indices::U32(wireframe_indices));
...
fn generate_cell_mesh(config: CellConfiguration, cell_x: f32, cell_y: f32) -> Option<CellMesh> {
    ...
    match case_index {
        0 => None, // All empty
        15 => Some(create_full_quad(cell_x, cell_y)), // All filled - this was missing!
